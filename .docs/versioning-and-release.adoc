...
All versions use plain https://semver.org/[Semantic Versioning] **with** a `v` prefix:
...
[IMPORTANT]
====
Always use the `v` prefix. The correct format is `v0.1.0`, not `0.1.0`.
====
...
| Git Tag
| Tag name matches the release version exactly (e.g., `v0.1.0`)

| GitHub Milestone
| Milestone name matches the release version without `v` prefix (e.g., `0.1.0`)
|===
...
1. **Generates a changelog** using https://github.com/spring-io/github-changelog-generator[spring-io/github-changelog-generator] based on the GitHub milestone matching the tag name (without `v` prefix)
...
| `v0.0.1`
| `0.0.1`
| https://github.com/{repo}/releases/tag/v0.0.1[v0.0.1]

| v0.0.2
| `v0.0.2`
| `0.0.2`
| https://github.com/{repo}/releases/tag/v0.0.2[v0.0.2]

| v0.0.3
| `v0.0.3`
| `0.0.3`
| https://github.com/{repo}/releases/tag/v0.0.3[v0.0.3]
|===
